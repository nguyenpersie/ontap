<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
          <h1 class="modal-title fs-5" id="modaleditLabel{{ $user->id }}">Edit user</h1>
                ...
                <div class="col-sm-10">
                  <div class="form-check">
                    <label class="form-check-label col-sm-3">
                      ...
                      <input class="form-check-input radio-inline" type="radio" name="is_active" id="is_active" value="2" {{ ($user->is_active == 2) ? 'checked' : null }}>No</label>
                  </div>
               </div>
            </fieldset>
        </div>
