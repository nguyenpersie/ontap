                        ...
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-outline-info btn-custom btn-sm w-full"
                                    onclick="showEdit({{ $user->id }})">
                                    <i class="fas fa-edit"></i>
                                    Edit
                                </button>
                                <a href="{{ route('user.delete', ['id' => $user->id]) }}" class="btn btn-outline-danger btn-custom">Delete</a>
                                <button class="btn btn-outline-secondary btn-custom" data-bs-toggle="modal" data-bs-target="#modalReview">Review</button>
                            </td>
...
<script>
    function showEdit(id) {
            const url = "{{ route('user.edit', ['id' => ':id']) }}".replace(":id", id);
            $.ajax({
                url: url,
                type: "GET",
