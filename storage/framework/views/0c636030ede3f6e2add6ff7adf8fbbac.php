...
<form action="<?php echo e(route('customer.add.post')); ?>" method="POST" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
...
<?php /**PATH /var/www/review/resources/views/customer/modal/add.blade.php ENDPATH**/ ?>